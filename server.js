...
connection.once("open", () => {
    ...
    console.log("MongoDB Connection is Successful"); //display message in console when the connection was successful
});
...
app.use("/mindful", require("./BACKEND/routes/events"));
